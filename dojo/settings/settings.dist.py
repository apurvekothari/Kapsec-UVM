...
env = environ.Env(
    ...
    DD_SITE_URL=(str, 'http://127.0.0.1:8000'),
    DD_DEBUG=(bool, True),
    ...
    DD_CELERY_BROKER_SCHEME=(str, 'amqp'),
    DD_CELERY_BROKER_USER=(str, 'guest'),
    DD_CELERY_BROKER_PASSWORD=(str, 'guest'),
    DD_CELERY_BROKER_HOST=(str, '127.0.0.1'),
    DD_CELERY_BROKER_PORT=(int, 5672),
    DD_CELERY_BROKER_PATH=(str, '//'),
    ...
    DD_DATABASE_HOST=(str, '127.0.0.1'),
...
ALLOWED_HOSTS = tuple(env.list('DD_ALLOWED_HOSTS', default=['127.0.0.1']))
