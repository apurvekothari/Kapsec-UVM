# Generated by Django 2.2.14 on 2020-09-02 05:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('protocol', models.CharField(blank=True, help_text="The communication protocol such as 'http', 'ftp', etc.", max_length=10, null=True)),
                ('host', models.CharField(blank=True, help_text="The host name or IP address, you can also include the port number. For example'127.0.0.1', '127.0.0.1:8080', 'localhost', 'yourdomain.com'.", max_length=500, null=True)),
                ...
                ('path', models.CharField(blank=True, help_text="The location of the resource, it should start with a '/'. For example/endpoint/420/edit", max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cve', models.CharField(help_text='CVE or other vulnerability identifier', max_length=28, null=True, validators=[django.core.validators.RegexValidator(message="Vulnerability ID must be entered in the format: 'ABC-9999-9999'.", regex='^[A-Z]{1,10}(-\\d+)+$')])),
                ...
                ('hash_code', models.CharField(blank=True, editable=False, max_length=64, null=True)),
                ('line', models.IntegerField(blank=True, help_text='Line number. For SAST, when source (start of the attack vector) and sink (end of the attack vector) information are available, put sink information here', null=True, verbose_name='Line number')),
                ('file_path', models.CharField(blank=True, help_text='File name with path. For SAST, when source (start of the attack vector) and sink (end of the attack vector) information are available, put sink information here', max_length=4000, null=True)),
                ('component_name', models.CharField(blank=True, help_text='Name of the component containing the finding. ', max_length=200, null=True)),
                ('component_version', models.CharField(blank=True, help_text='Version of the component.', max_length=100, null=True)),
                ('static_finding', models.BooleanField(default=False)),
                ('dynamic_finding', models.BooleanField(default=True)),
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('jira_creation', models.DateTimeField(null=True)),
                ('jira_change', models.DateTimeField(null=True)),
                ...
                ('unique_id_from_tool', models.CharField(blank=True, help_text='Vulnerability technical id from the source tool. Allows to track unique vulnerabilities', max_length=500, null=True)),
                ('sast_source_object', models.CharField(blank=True, help_text='Source object (variable, function...) of the attack vector', max_length=500, null=True)),
                ('sast_sink_object', models.CharField(blank=True, help_text='Sink object (variable, function...) of the attack vector', max_length=500, null=True)),
                ('sast_source_line', models.IntegerField(blank=True, help_text='Source line number of the attack vector', null=True, verbose_name='Line number')),
                ('sast_source_file_path', models.CharField(blank=True, help_text='Source filepath of the attack vector', max_length=4000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cve', models.CharField(max_length=28, null=True, validators=[django.core.validators.RegexValidator(message="Vulnerability ID must be entered in the format: 'ABC-9999-9999'.", regex='^[A-Z]{1,10}(-\\d+)+$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_issue_type', models.CharField(choices=[('Task', 'Task'), ('Story', 'Story'), ('Epic', 'Epic'), ('Spike', 'Spike'), ('Bug', 'Bug'), ('Security', 'Security')], default='Bug', help_text='You can define extra issue types in settings.py', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dojo.Note_Type')),
            ],
        ),
        migrations.CreateModel(
            name='Notes',
            fields=[
                ...
                ('history', models.ManyToManyField(blank=True, editable=False, to='dojo.NoteHistory')),
                ('note_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='note_type', to='dojo.Note_Type')),
            ],
            options={
                'ordering': ['-date'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jira_minimum_severity', models.CharField(blank=True, choices=[('Critical', 'Critical'), ('High', 'High'), ('Medium', 'Medium'), ('Low', 'Low'), ('Info', 'Info')], default='Low', max_length=20, null=True)),
                ('jira_labels', models.CharField(blank=True, help_text='JIRA issue labels space seperated', max_length=200, null=True)),
                ('enable_github', models.BooleanField(default=False, verbose_name='Enable GITHUB integration')),
                ('enable_slack_notifications', models.BooleanField(default=False, verbose_name='Enable Slack notifications')),
                ('slack_channel', models.CharField(blank=True, default='', help_text='Optional. Needed if you want to send global notifications.', max_length=100)),
                ...
                ('slack_username', models.CharField(blank=True, default='', help_text='Optional. Will take your bot name otherwise.', max_length=100)),
                ...
                ('allow_anonymous_survey_repsonse', models.BooleanField(default=False, help_text='Enable anyone with a link to the survey to answer a survey', verbose_name='Allow Anonymous Survey Responses')),
                ('credentials', models.CharField(blank=True, max_length=3000)),
                ('column_widths', models.CharField(blank=True, max_length=1500)),
                ('drive_folder_ID', models.CharField(blank=True, max_length=100)),
                ('enable_google_sheets', models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Descriptive name which in the future may also be used to group risk acceptances together across engagements and products', max_length=100)),
                ...
                ('owner', models.ForeignKey(help_text='Only the owner and staff users can edit the risk acceptance.', on_delete=django.db.models.deletion.CASCADE, to='dojo.Dojo_User')),
            ],
        ),
        migrations.CreateModel(
            name='Report',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scan_added', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('slack', 'slack'), ('hipchat', 'hipchat'), ('mail', 'mail'), ('alert', 'alert')], default='alert', help_text='Triggered whenever an (re-)import has been done that created/updated/closed findings.', max_length=24)),
                ...
                ('product', models.ForeignKey(default=None, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='dojo.Product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('push_all_issues', models.BooleanField(blank=True, default=False, help_text='Automatically maintain parity with JIRA. Always create and update JIRA tickets for findings in this Product.')),
        ...
        migrations.AddField(
            ...
            name='finding',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='status_finding', to='dojo.Finding'),
        ),
        migrations.AddField(
            model_name='endpoint_status',
            name='mitigated_by',
        ...
        migrations.AddField(
            ...
            name='answer',
            field=models.ManyToManyField(help_text='The selected choices as the answer', to='dojo.Choice'),
        ),
        migrations.AlterUniqueTogether(
            name='benchmark_product_summary',
